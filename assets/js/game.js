...
// You can aslo log multiple values at once like this console console.log(playerName, playerAttack, playerHealth);
...
var fight = function() {
    ...
    // if player choses to fight, then night
...
//Subtract the value of 'playerAttack' from the value of 'enemyHealth' and use that result to update the value in the 'enemyHealth' variable enemyHealth - playerAttack;
...
// Subtract the value of 'enemyAttack' from the value of 'playerHealth' and use that result to update the value in the 'playerHealth' variable playerHealth = playerHealth - enemyAttack;
...
/* // this cretaes a function named fight
